...
The **Finance Assistant** is packed with features designed to take you from simple expense tracking to intelligent financial planning.

## 🚀 Core Functionality

### 1. User Authentication
*   **Secure Access:** Register and log in securely using email and password.
*   **Data Privacy:** All financial data is isolated per user, ensuring complete privacy.

### 2. Expense Tracking
*   **CRUD Operations:** Add, read, update, and delete transactions easily.
*   **Categorization:** Organize spending into categories (e.g., Food, Travel, Rent, Shopping).
*   **History:** View detailed transaction history filtered by month.
*   **Export Data:** Download a PDF summary of your monthly transactions for offline records.

### 3. Budget Management
*   **Monthly Limits:** Set a global monthly budget to keep your spending in check.
...
*   **Visual Charts:** Interactive Line (Trend) and Bar (Category) charts to visualize spending habits.

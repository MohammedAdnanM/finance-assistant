...
export default function App() {
	...
	async function deleteTransaction(tx) {
		...
		const res = await fetch(`${API_BASE}/delete/${tx.id}`, {
			method: "DELETE",
		});
		...
		success(
			<span>
				Transaction deleted —
				<button onClick={undoDelete} className="ml-2 underline text-blue-400">
					Undo
				</button>
			</span>
		);
	...
	/* ---------------- MAIN UI ---------------- */
	return (
		<div className="min-h-screen flex bg-white text-black dark:bg-[#0d1117] dark:text-white">
			{/* SIDEBAR */}
			<aside
				...
				<h1 className="text-3xl font-bold hidden group-hover:block">Finora</h1>
			...
			<main className="flex-1 p-10 space-y-12 overflow-y-auto">
				...
				<header
                   ...
                   dark:bg-[#0d1117]/90 dark:border-gray-800
                   backdrop-blur">
					<section
						className="bg-gray-100 border border-gray-300
                   dark:bg-[#111827] dark:border-gray-800
                   rounded-2xl px-8 py-4 space-y-5">
						{/* TOP ROW */}
                 ...
                 hover:bg-red-500/10 transition">
						...
						<div className="flex items-center justify-between gap-8">
							<div>
								...
								<input
									...
									className="mt-2 p-3 rounded-xl w-56
                    bg-white text-black border border-gray-300
                    dark:bg-gray-800 dark:text-white dark:border-gray-700"
                  ...
                  p-4 rounded-xl">
							...
							<div className="text-sm">
								<p>
									Spent:{" "}
									<span className="text-blue-400 font-semibold">₹ {spent}</span>
								</p>
								<p>
									Remaining:{" "}
									<span
										className={
											budget - spent < 0 ? "text-red-400" : "text-green-400"
										}>
										₹ {budget - spent}
									</span>
								</p>
				...
				<section
                   ...
                   rounded-2xl p-8">
					...
					<table className="w-full border border-gray-800 rounded-xl overflow-hidden">
						<thead className="bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-300">
							<tr>
